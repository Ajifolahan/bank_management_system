...
//void user_login();     <<<<organized to get rid of these and the warnings
//void admin_login();
int view_customers();
int add_customer();
...
void admin_login(){
    ...
    if (found) {
        ...
        puts("1. View Customer Info  2. Add Customers  3. Sort");
        scanf("%d", &choice);
...
int add_customer(){
    ...
    //creating user file
        ...
        fclose(add_to_login); // add and close file


        // need to finish
        int choice;
        puts("Options: 1.Admin Page  2.Exit");
        scanf("%d", &choice);
